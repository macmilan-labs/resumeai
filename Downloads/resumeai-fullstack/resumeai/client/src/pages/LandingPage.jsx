...
const Hero = () => {
  ...
  return (
    <header className="pt-20 pb-24 px-8 text-center max-w-5xl mx-auto animate-in fade-in slide-in-from-top-4 duration-1000">
      ...
      <h1 className="text-6xl md:text-8xl font-black text-slate-900 leading-[0.95] mb-10 tracking-tight">
        ...
        <span className="text-blue-600 bg-clip-text">get hired anymore.</span>
      </h1>
      <p className="text-lg md:text-xl text-slate-500 mb-14 max-w-3xl mx-auto leading-relaxed font-inter font-medium">
        Our proprietary AI engine reverse-engineers modern ATS algorithms to give you the exact keywords and phrasing needed for a <span className="text-slate-900 font-bold underline decoration-blue-500/30">90+ match score.</span>
      </p>
      <div className="flex flex-col sm:flex-row justify-center items-center gap-5">
        <button 
          onClick={() => navigate('/analyze')}
          className="group w-full sm:w-auto px-10 py-5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl shadow-2xl shadow-blue-200 transition-all active:scale-95 flex items-center justify-center gap-3"
        >
          Analyze Resume Now
        ...
        <button 
          ...
          className="w-full sm:w-auto px-10 py-5 bg-white border border-slate-200 text-slate-700 font-bold rounded-2xl hover:bg-slate-50 hover:border-slate-300 transition-all active:scale-95 flex items-center justify-center gap-3"
        >
          <span className="material-icons-outlined text-blue-600">visibility</span>
          View Sample Result
        </button>
      </div>
      ...
      <div className="max-w-7xl mx-auto bg-slate-900 rounded-[3.5rem] border-l-[12px] border-l-blue-600 p-16 md:p-32 text-center relative overflow-hidden shadow-2xl">
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <button 
              onClick={() => navigate('/analyze')}
              className="w-full sm:w-auto px-12 py-5 bg-blue-600 text-white font-bold rounded-2xl shadow-xl hover:scale-105 transition-all active:scale-95 whitespace-nowrap"
            >
              Get Started for Free
            </button>
            <Link to="/pricing" className="w-full sm:w-auto">
              <button className="w-full px-12 py-5 bg-white/5 hover:bg-white/10 text-white border border-white/10 font-bold rounded-2xl transition-all backdrop-blur-md active:scale-95 whitespace-nowrap">
                Check Pro Pricing
              </button>
            </Link>
          </div>
