      ...
      <div className="flex items-center gap-6">
        ...
        {!userToken ? (
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="px-4 py-2 bg-slate-50 text-slate-500 hover:text-red-600 hover:bg-red-50 text-xs font-bold rounded-xl transition-all"
            >
              Logout
            </button>
          </div>
        ...
        {isProUser ? (
          ...
          <button 
            ...
            className="hidden sm:flex items-center gap-2 px-6 py-2.5 bg-orange-500 hover:bg-orange-600 text-white text-[11px] font-black uppercase tracking-[0.15em] rounded-xl shadow-lg shadow-orange-200 transition-all duration-300 hover:shadow-orange-300 active:scale-95"
          >
