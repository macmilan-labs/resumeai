...
const { saveAnalysis, getHistory, getUsageCount, clearHistory, getAnalysisById, deleteAnalysisById } = require('../services/historyService');
...
async function deleteAnalysis(req, res) {
  ...
  const success = deleteAnalysisById(id, email);
  if (!success) {
...
module.exports = { analyzeResume, getCoverLetter, getKeywords, getAnalysesHistory, verifyAuth, clearAnalysesHistory, getAnalysisDetail, deleteAnalysis };
