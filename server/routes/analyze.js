...
const { analyzeResume, getCoverLetter, getKeywords, getAnalysesHistory, verifyAuth, clearAnalysesHistory, getAnalysisDetail, deleteAnalysis } = require('../controllers/analyzeController');
